...
* объявление модулей в пространстве имен приложения;
* хранилище начальных настроек модулей приложения;
* регистрация внешних зависимостей модуля;
* формирование очереди загрузки внешних модулей.

[Демонстрация][example] основных техник практического применения библиотеки.

[example]: http://mistakster.github.com/app-skeleton/example/
...
При соответствующей [конфигурации HTTP-сервера][1] такой подход предоставляет удобный способ
управления кешированием статических файлов браузером.

[1]: https://github.com/h5bp/html5-boilerplate/blob/v4.0.0/doc/htaccess.md#cache-busting
